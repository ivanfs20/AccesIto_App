        ...
        GlobalScope.launch(Dispatchers.IO){
            ...
            if(usuario!=null){
                ...
                if(qr!=null){
                    ...
                    runOnUiThread {
                        Toast.makeText(this@DocenteActivity,"Qr no encontrado",Toast.LENGTH_SHORT).show()
                    }
                }
            }else{
                runOnUiThread {
                    Toast.makeText(this@DocenteActivity, "Usuario no encontrado", Toast.LENGTH_SHORT).show()
                }
            }
        }
        //boton salir
